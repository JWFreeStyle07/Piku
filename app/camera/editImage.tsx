...
export default function EditImage() {
  ...
  const fetchPhotoMetadata = async () => {
    try {
      ...
      Alert.alert('Error', 'Failed to load photo information.');
    } finally {
      ...
      <View style={styles.content}>
        ...
        >
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              <View style={styles.modalHeader}>
                <Text style={styles.modalTitle}>Photo Information</Text>
                <TouchableOpacity
              ...
              <ScrollView style={styles.infoContent}>
                {loadingMetadata ? (
                  <View style={styles.loadingInfo}>
                    <ActivityIndicator size="large" color="#E5A602" />
                    <Text style={styles.loadingText}>Loading information...</Text>
                  </View>
                ) : photoMetadata ? (
                  <View style={styles.infoList}>
                    <View style={styles.infoItem}>
                      <MaterialCommunityIcons name="file-image" size={24} color="#E5A602" />
                      <View style={styles.infoTextContainer}>
                        <Text style={styles.infoLabel}>File Name</Text>
                        <Text style={styles.infoValue}>{photoMetadata.name}</Text>
                      </View>
                    </View>

                    <View style={styles.infoItem}>
                      <MaterialCommunityIcons name="file-document" size={24} color="#E5A602" />
                      <View style={styles.infoTextContainer}>
                        <Text style={styles.infoLabel}>File Type</Text>
                        <Text style={styles.infoValue}>{photoMetadata.contentType}</Text>
                      </View>
                    </View>

                    <View style={styles.infoItem}>
                      <MaterialCommunityIcons name="harddisk" size={24} color="#E5A602" />
                      <View style={styles.infoTextContainer}>
                        <Text style={styles.infoLabel}>File Size</Text>
                        <Text style={styles.infoValue}>{formatFileSize(photoMetadata.size)}</Text>
                      </View>
                    </View>

                    <View style={styles.infoItem}>
                      <MaterialCommunityIcons name="calendar-plus" size={24} color="#E5A602" />
                      <View style={styles.infoTextContainer}>
                        <Text style={styles.infoLabel}>Date Created</Text>
                        <Text style={styles.infoValue}>{formatDateTime(photoMetadata.timeCreated)}</Text>
                      </View>
                    </View>

                    <View style={styles.infoItem}>
                      <MaterialCommunityIcons name="calendar-edit" size={24} color="#E5A602" />
                      <View style={styles.infoTextContainer}>
                        <Text style={styles.infoLabel}>Last Modified</Text>
                        <Text style={styles.infoValue}>{formatDateTime(photoMetadata.updated)}</Text>
                      </View>
                    </View>

                    <View style={styles.infoItem}>
                      <MaterialCommunityIcons name="folder-open" size={24} color="#E5A602" />
                      <View style={styles.infoTextContainer}>
                        <Text style={styles.infoLabel}>Event</Text>
                        <Text style={styles.infoValue}>{eventName || eventId}</Text>
                      </View>
                    </View>
                  </View>
                ) : (
                  <View style={styles.errorInfo}>
                    <MaterialCommunityIcons name="alert-circle" size={48} color="#F81C1F" />
                    <Text style={styles.errorText}>Failed to load photo information</Text>
                  </View>
                )}
              </ScrollView>
            </View>
