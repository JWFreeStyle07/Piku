...
//     try {
//       // Check if ImagePicker methods are available
...
//       // Try to request permissions if the method exists
...
//     try {
//       // Generate a unique user ID (you can also use Firebase Auth UID)
